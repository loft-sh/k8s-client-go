...
func TestTLSConfigKey(t *testing.T) {
	...
	uniqueConfigurations := map[string]*Config{
		...
		"dialer with cache disabled": {DialHolder: &DialHolder{DisableTLSTransportCache: true, Dial: dialer.DialContext}},
	...
	for nameA, valueA := range uniqueConfigurations {
		for nameB, valueB := range uniqueConfigurations {
			...
			shouldCacheA := valueA.Proxy == nil && (valueA.DialHolder == nil || !valueA.DialHolder.DisableTLSTransportCache)
